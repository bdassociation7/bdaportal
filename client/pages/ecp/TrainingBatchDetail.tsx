 ...
 * View detailed information about a specific training batch
 */
...
export default function ECPTrainingBatchDetail() {
    ...
    return (
      <div className="space-y-6">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Training batch not found or you don't have permission to view it.
          </AlertDescription>
        </Alert>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="secondary"
              size="sm"
              onClick={() => navigate(`/ecp/trainings/${id}/edit`)}
            >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              className="w-full"
              variant="outline"
              onClick={() => navigate(`/ecp/candidates?batch_id=${batch.id}`)}
            >
