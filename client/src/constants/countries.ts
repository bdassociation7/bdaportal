...
/**
 * ISO 3166-1 country and territory options, sorted alphabetically by English name.
 * Values stored in profiles are ISO alpha-2 country codes; dial codes are display-only.
 */
export const COUNTRY_OPTIONS: CountryOption[] = [
  { code: 'AF', name: 'Afghanistan', dialCode: '+93' },
  { code: 'AX', name: 'Åland Islands', dialCode: '+35818' },
  ...
  { code: 'SH', name: 'Saint Helena, Ascension and Tristan da Cunha', dialCode: '+2' },
  ...
  { code: 'VA', name: 'Vatican City', dialCode: '+3' },
  { code: 'VE', name: 'Venezuela', dialCode: '+58' },
  { code: 'VN', name: 'Vietnam', dialCode: '+84' },
  { code: 'WF', name: 'Wallis and Futuna', dialCode: '+681' },
  { code: 'EH', name: 'Western Sahara', dialCode: '+2' },
  { code: 'YE', name: 'Yemen', dialCode: '+967' },
  { code: 'ZM', name: 'Zambia', dialCode: '+260' },
  { code: 'ZW', name: 'Zimbabwe', dialCode: '+263' },
];

export function getCountryOption(countryCode?: string | null): CountryOption | undefined {
...
export function countryDialCode(countryCode?: string | null): string {
  return getCountryOption(countryCode)?.dialCode || '';
}
