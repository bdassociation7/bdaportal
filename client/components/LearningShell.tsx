...
function getNavItems(basePath: string): NavItem[] {
  return [
    ...
    },
    {
      ...
      matchFn: (pathname) =>
        pathname.includes("/question-bank") && !pathname.includes("/admin"),
    },
    {
      label: "Flashcards",
      ...
      matchFn: (pathname) =>
        pathname.includes("/flashcards") && !pathname.includes("/admin"),
    },
    {
      label: "Analytics",
      ...
      >
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          <img
            ...
            className="h-14 w-[166px] shrink-0 object-contain sm:h-16 sm:w-[192px]"
          />
          <div className="min-w-0 border-l border-white/25 pl-3 sm:pl-4">
            ...
            <p className="hidden text-xs font-medium tracking-wide text-white/75 sm:block">
  ...
  return (
    <ShellContext.Provider
      value={{
        ...
        isLessonMode: immersive,
      }}
    >
      <div
        className={`min-h-screen bg-[#f8f9fb] ${isArabic ? "font-arabic" : ""}`}
