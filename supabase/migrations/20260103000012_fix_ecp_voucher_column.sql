-- Migration: Fix ecp_vouchers column name
-- Date: 2026-01-03
-- Description: Use trainee_id instead of assigned_to (which doesn't exist)
...
SELECT '✅ Fixed ecp_vouchers column: trainee_id instead of assigned_to' as status;
