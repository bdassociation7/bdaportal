-- Migration: Fix check_exam_eligibility - Cast attempt_status enum to TEXT
-- Date: 2026-01-03
-- Description: The quiz_attempts.status is an enum, must cast to TEXT

-- =============================================================================
-- FIX: check_exam_eligibility function
-- Cast attempt_status enum to TEXT for proper return type
-- =============================================================================
...
BEGIN
    ...
    -- Cast status enum to TEXT for return type compatibility
    ...
    IF v_attempt.id IS NOT NULL THEN
        RETURN QUERY SELECT
            ...
            true, v_attempt.id, v_attempt.status::TEXT,
...
SELECT '✅ Fixed check_exam_eligibility - cast attempt_status enum to TEXT' as status;
