-- Migration: Fix search_certifications_unified RPC function - Remove non-existent metadata column
-- Date: 2026-01-09
-- Description: Fixes the RPC function to match actual table structure
...
DO $$
BEGIN
    RAISE NOTICE '✅ search_certifications_unified function fixed successfully';
    RAISE NOTICE '🔧 Removed non-existent metadata column';
    RAISE NOTICE '✓ Function now matches actual table structure';
END $$;
