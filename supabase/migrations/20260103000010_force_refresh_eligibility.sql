-- Migration: Force refresh check_exam_eligibility function
-- Date: 2026-01-03
-- Description: Re-apply function with explicit schema references
...
BEGIN
    -- Get quiz info (explicit public schema)
    ...
    -- Check for existing in-progress attempt (explicit public schema)
...
SELECT '✅ Function refreshed with explicit schema references' as status;
