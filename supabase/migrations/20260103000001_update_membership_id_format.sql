-- Migration: Update Membership ID Format
-- Date: 2026-01-03
-- Description: Changes membership ID format from BDA-MEM-YYYY-XXXX to BDA-PM-YYYYNNNNN
-- Where: YYYY is the full year, NNNNN is a 5-digit sequential number
...
BEGIN
    ...
    -- Format: BDA-PM-YYYYNNNNN (e.g., BDA-PM-202510016)
...
SELECT '✅ Membership ID format updated to BDA-PM-YYYYNNNNN' as status;
