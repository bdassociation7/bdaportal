...
const corsHeaders = {
  // The JWT is required and verified; allowing the CORS preflight avoids
  // browser-side request rejection before the administrator request reaches this function.
